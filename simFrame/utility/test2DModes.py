...
inputModes = [{'pos':[[12,12,0],[12,dims[1]-12,0]], 'modeNum': 4},
                {'pos':[[12,12,0],[12,dims[1]-12,0]], 'modeNum': 6}]
...
epsilon = buildStructure(SiNThickness=SiNThickness,dims=dims,
    designArea=designArea,structureScalingFactor=structureScalingFactor,structure=structure,testStraightWG=True)
